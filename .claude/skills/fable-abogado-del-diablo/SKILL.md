...
description: Crítica constructiva al estilo Fable 5. Usar cuando pidan opinión sobre un plan, una idea o un proyecto, cuando pidan jugar al abogado del diablo, y SIEMPRE en la Fase 2 del arranque de un proyecto.
---
